...
position = 00000000
; 인쇄 크기 (8자리, 앞4=너비, 뒤4=높이, 단위 0.1mm; 비워두면 -S 미사용)
size =
; 배율 (4자리, 단위 0.1%; 비워두면 -R 미사용; -S와 동시 사용 불가)
magnification =
...
GTX4CMD_KEYS = [
    "position", "size", "magnification", "white_as",
...
def reload():
    ...
    global POSITION, SIZE, MAGNIFICATION, WHITE_AS
